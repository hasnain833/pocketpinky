...
export const AuthModal = ({ isOpen, onClose, initialMode = "login" }: AuthModalProps) => {
    ...
    const isForgotPassword = (mode as string) === "forgot-password";
            ...
            <DialogContent className="bg-[hsl(var(--cream))] border-[hsl(var(--divider))] sm:max-w-[450px] p-0 overflow-hidden">
                <div className="p-5">
                    <DialogHeader className="mb-3">
                        ...
                        <DialogDescription className="text-[10px] text-[hsl(var(--text-muted))] text-center">
                            {isSignup ? "Sign up to start your journey." : isForgotPassword ? "Enter your email to receive a password reset link." : "Sign in to access your coaching sessions."}
                        </DialogDescription>
                    </DialogHeader>
